({
    doOnClose : function(cmp, event) {
        // notice parent component to go back to the QuoteLineItemBulkEdit component
        ...
        .then($A.getCallback(function(response) {
            ...
            if(returnVal.returnCode == 0){
                ...
                if(cmp.get('v.isPSGHHTUser')){
                    columns = [
                        //{label: "Id", fieldName: 'product2_Id', type: 'text', initialWidth:250, sortable: true},
                        {label: "値引対象外フラグ", fieldName: 'product2_NoDiscountFlg', type: 'boolean', initialWidth:250, sortable: false},
                        ...
                        {label: $A.get("$Label.c.COWO_LBL_PartsNo"), fieldName: 'product2_PartsNo', type: 'text',initialWidth:70, type: 'text', sortable: false},
    ...
    getColumnDefinitions: function () {
        ...
        var columns = [
            {label: "Id", fieldName: 'product2_Id', type: 'text', initialWidth:250, sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_ItemName"), fieldName: 'product2_ItemName', type: 'text', initialWidth:250, sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_ProdDescription"), fieldName: 'product2_Description', type: 'text', initialWidth:350, sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_Katashiki"), fieldName: 'product2_Katashiki', type: 'text', initialWidth:250,sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_B"), fieldName: 'product2_b', type: 'currency', initialWidth:200, sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_X"), fieldName: 'partitionPrice', type: 'currency', initialWidth:200, sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_Q"), fieldName: 'product2_Q', type: 'currency',  initialWidth:200, sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_TC"), fieldName: 'product2_TC', type: 'currency', initialWidth:200, sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_MC"), fieldName: 'product2_MC', type: 'currency',  initialWidth:200, sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_ProductCode"), fieldName: 'product2_ProductCode', type: 'text',initialWidth:200, type: 'text', sortable: false},
            {label: $A.get("$Label.c.COWO_LBL_PartsNo"), fieldName: 'product2_PartsNo', type: 'text',initialWidth:200, type: 'text', sortable: false}
